...
public class PsetHind extends AppCompatActivity {
 ...
 AdView mAdView12 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView11 = findViewById(R.id.adView1);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView11.loadAd(adRequest);

        mAdView12 = findViewById(R.id.adView2);
   ...
   /*     FirebaseDatabase database = FirebaseDatabase.getInstance();
    ...
    private void updateQustion(){
        ...
        if(total>30){
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("QuestionsHind").child(String.valueOf(total));
