...
public class PsetReas extends AppCompatActivity {
   ...
   /*     FirebaseDatabase database = FirebaseDatabase.getInstance();
    ...
    private void updateQustion(){
        ...
        if(total>30){
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("QuestionsReas").child(String.valueOf(total));
