...
public class PsetEng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdview3 = findViewById(R.id.adView1);
        AdRequest adRequest3 = new AdRequest.Builder().build();
        mAdview3.loadAd(adRequest3);

        mAdview4 = findViewById(R.id.adView2);
   ...
   /*     FirebaseDatabase database = FirebaseDatabase.getInstance();
    ...
    private void updateQustion(){
        ...
        if(total>30){
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("QuestionsEng").child(String.valueOf(total));
